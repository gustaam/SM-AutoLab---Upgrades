...
A release atualmente publicada é **v2.99.29**.

A **v2.99.30** inclui o ajuste de posicionamento adaptativo do submenu de Aparência, que passa a abrir pelo lado com espaço disponível dentro da janela.
