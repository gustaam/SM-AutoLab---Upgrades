...
A release atualmente publicada é **v2.99.30**.

A **v2.99.31** remove a aba **Não executados** da área de acompanhamento. Os códigos com erro continuam registrados nos indicadores, alertas e detalhes do histórico.
