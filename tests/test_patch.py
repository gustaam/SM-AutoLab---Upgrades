...
class TestPatch(unittest.TestCase):
    ...
    def test_build_manual_usa_mesmo_fluxo_de_integracao_do_ci(self):
        ...
        build = (root / "build_windows.bat").read_text(encoding="utf-8")
        self.assertIn(
            "from main import _corrigir_historico_ilimitado, _validar_base_aplicacao, install_ui_29912, install_ui_fluent_29916",
            build,
        )
        self.assertIn(
            "aplicar_patch_ui(App); _corrigir_historico_ilimitado(); install_ui_29912(App); install_ui_fluent_29916(App); _validar_base_aplicacao()",
            build,
        )
        self.assertNotIn(
