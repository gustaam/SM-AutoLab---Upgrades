...
echo.
echo Preparando Chrome for Testing integrado ao executavel...
...
if not exist "build_resources\chrome_for_testing\version.txt" goto :erro
echo Chrome for Testing + ChromeDriver preparados: OK
echo.
