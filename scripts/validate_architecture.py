...
REQUIRED_PATHS = (
    ...
    "scripts/validate_architecture.py", "scripts/validate_executable.py", "planilha_core.py", "tests/test_patch.py", "tests/test_planilha_open_path.py", "tests/test_planilha_core.py", "tests/test_validate_executable.py", "windows11_native_29925.py", "tests/test_stage12.py",
)
...
def validate(root: Path) -> None:
    ...
    require_markers("interface.py", interface, ("def abrir_planilha(self, dados_iniciais=None):", "self._planilha_implementacao = \"grade-final-29922\"",
